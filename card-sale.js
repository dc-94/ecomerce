class cardS extends HTMLElement {
    ...
    static get observedAttributes() {
        return ['titulo',"prodnum", "mxcj", "desc", "categoria", "preciod", "precion", "off", "marca", "material", "uso", "formato", "src1", "src2"];
    }
                  ...
                  <div class="pCard_body_modal_content_body_info">
                    ...
                    <div class="pCard_body_modal_content_body_info_btns">
                      ...
                      <button type="button" class="wsp ">
                        <a href="https://api.whatsapp.com/send?phone=543413094710&text=Hola%21%.20m%C3%A1s%20rmaci%C3%B3n%20sobre%20${this.titulo}-${this.prodnum}%202." target="_blank">Consultar</a>
                      </button>
                    </div>
                </div>
              </div>
